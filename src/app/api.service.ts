...
export class ApiService {
  // baseUrl:string = "https://flamingostech.com/flamingostech_handler"; //in root flamingostech.com
  baseUrl:string = "https://dev.flamingostech.com/flamingostech_handler"; //in DEV dev.flamingostech.com
